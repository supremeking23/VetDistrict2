                  ...
                  <tbody>
                    ...
                    <?php foreach($get_all_sales as $sales):?>
                      ...
                      <tr>
                        ...
                        <td> <?php echo ucfirst( $sales->customer_type);?></td>

                        <td>₱<?php echo $sales->sales_total;?></td>
                        <td> 

                         <!-- not use <a href="<?php echo site_url();?>admin/sales_full_details/<?php echo $sales->sales_id;?>" class="btn btn-primary btn-sm" target="_blank">View Detail</a> -->

                           <a role="button"  class="btn btn-primary btn-sm" data-toggle="modal" data-target="#sales_full_details<?php echo $sales->sales_id?>"><span class="glyphicon glyphicon-fullscreen"> </span>
                            View Full Detail
                          </a>
