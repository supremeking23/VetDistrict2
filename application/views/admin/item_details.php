            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    <label for="pet_name" class="col-sm-2 control-label">Item Name</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="pet_name" name="item_name" value="<?php echo $item_details->item_name?>">
                    </div>
                  </div>
