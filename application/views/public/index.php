...
<header>
  ...
  <div class="carousel fade" data-ride="carousel" id="featured">
    ...
    <div class="carousel-inner fullheight">
      <div class="item"><img src="<?php echo site_url();?>assets/images/carousel-lifestyle.jpg" alt="Lifestyle Photo"></div>
      <div class="item"><img src="<?php echo site_url();?>assets/images/carousel-mission.jpg" alt="Mission"></div>
      <div class="item"><img src="<?php echo site_url();?>assets/images/carousel-vaccinations.jpg" alt="Vaccinations"></div>
      <div class="item"><img src="<?php echo site_url();?>assets/images/carousel-fish.jpg" alt="Fish"></div>
      <div class="item"><img src="<?php echo site_url();?>assets/images/carousel-exoticanimals.jpg" alt="Exotic Animals"></div>      
    </div><!-- carousel-inner -->
  ...
  <div class="page" id="services">
    <div class="content container">
      ...
      <div class="row">
        ...
        <article class="service col-md-4 col-sm-6 col-xs-12">
          <img class="icon" src="<?php echo site_url();?>assets/images/icon-vaccinations.svg" alt="Icon">
          <h3>Vaccinations</h3>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="doctor col-lg-4">
          <div class="row">
            <div class="photo col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-2 col-lg-4 col-lg-offset-0">
              <img class="img-circle" src="<?php echo site_url();?>assets/images/doctor-winthrop.jpg" alt="Photo of Dr Sanders">
            </div><!-- photo -->
        ...
        <div class="doctor col-lg-4">
          <div class="row">
            <div class="photo col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-2 col-lg-4 col-lg-offset-0">
              <img class="img-circle" src="<?php echo site_url();?>assets/images/doctor-chase.jpg"  alt="Photo of Dr Sanders">
            </div><!-- photo -->
            <div class="info col-xs-8 col-xs-offset-2 col-sm-7 col-sm-offset-0 col-md-6 col-lg-8">
              <h3>Dr. Chase</h3>
        ...
        <div class="doctor col-lg-4">
          <div class="row">
            <div class="photo col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-2 col-lg-4 col-lg-offset-0">
              <img class="img-circle" src="<?php echo site_url();?>assets/images/doctor-sanders.jpg" alt="Photo of Dr Sanders">
            </div><!-- photo -->
            <div class="info col-xs-8 col-xs-offset-2 col-sm-7 col-sm-offset-0 col-md-6 col-lg-8">
              <h3>Dr Sanders</h3>
