                  ...
                  <tbody>
                    ...
                    <?php foreach($item_inventory as $item_inv):?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php echo $item_inv->first_name . ' ' . $item_inv->middle_name . ' '. $item_inv->last_name; ?>
                          (<?php echo $item_inv->user_type;?>)
                        </td>
                  ...
                  <tbody>
                    ...
                    <?php foreach($medicine_inventory as $med_inv):?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php echo $med_inv->first_name . ' ' . $med_inv->middle_name . ' '. $med_inv->last_name; ?>
                          (<?php echo $med_inv->user_type;?>)
                        </td>
