            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                 <li class="list-group-item">
                   <?php $date =date_create($admin_details->date_added);
                         $admin_since= date_format($date,"F  Y ");?>
                  <b>Admin Since</b> <a class="pull-right"><?php echo $admin_since;?></a>
                </li>
                <li class="list-group-item">
                  <b>Admin ID</b> <a class="pull-right"><?php echo $admin_details->admin_user_id;?></a>
                </li>
                <li class="list-group-item">
            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                ...
                <fieldset>
                  ...
                  <?php //beginning form
                  echo form_open_multipart('admin/update_admin_details','class="form-horizontal"');
                  ?>
        ...
        <?php  //for messages?>
              ...
              <?php if ($this->session->flashdata('update_admin_success')) { ?>
               ...
               <?php } ?>
                ...
                <?php if ($this->session->flashdata('admin_state')) { ?>
                   ...
                   <div class="modal modal-success" id="successmodal" role="dialog">
                     ...
                     <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p> <?php echo $this->session->flashdata('admin_state'); ?> </p>
                      </div>
                      <div class="modal-footer">
                      <button type="button" class="btn btn-outline pull-right" data-dismiss="modal">Close</button>
                     </div>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                 ...
                                 <?php //beginning form
                                    echo form_open_multipart('admin/update_admin_state','class="form-horizontal"');
                              ?>
                                <div class="modal-body">
                                  <input type="hidden" name="current_state" value="<?php echo  $admin_details->is_active;?>">
                                  <input type="hidden" name="admin_id" value="<?php echo  $admin_details->admin_id;?>">
