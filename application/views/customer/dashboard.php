  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="col-lg-4 col-xs-12" data-tooltip="tooltip" title="Shows the total number of your appointments">
              <!-- small box -->
        ...
        <div class="col-lg-4 col-xs-12" data-tooltip="tooltip" title="Shows the total number of your pets">
          <!-- small box -->
        ...
        <!-- ./col -->
        <div class="col-lg-4 col-xs-12" data-tooltip="tooltip" title="Shows the total number of your purchased products">
          <!-- small box -->
