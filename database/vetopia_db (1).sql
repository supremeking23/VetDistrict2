...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2018 at 07:17 AM
...
INSERT INTO `tblsales` (`sales_id`, `customer_type`, `customer_name`, `customer_id`, `sales_total`, `sales_date`) VALUES
...
INSERT INTO `tblsales_detail` (`salesdetail_id`, `sales_id`, `product_type`, `product_name`, `sales_quantity`, `total_per_product`) VALUES
(1, 1, 'item', 'Dog Lace', 5, '280.00'),
(2, 2, 'item', 'Cat Food (70mg)', 6, '606.00'),
(3, 3, 'item', 'Cat Food (70mg)', 6, '606.00'),
(4, 3, 'medicine', 'Antibiotic C', 4, '1776.00'),
(5, 3, 'item', 'Dog Lace', 5, '280.00'),
(6, 4, 'item', 'Cat Food (70mg)', 6, '606.00'),
(7, 4, 'medicine', 'Antibiotic C', 4, '1776.00'),
(8, 4, 'item', 'Dog Lace', 5, '280.00'),
(9, 4, 'service', 'Nail Cutting (Big Breed)', 3, '450.00'),
(10, 5, 'item', 'Dog Lace', 5, '280.00'),
(11, 5, 'item', 'Cat Food (70mg)', 2, '202.00'),
(12, 5, 'medicine', 'Vitamin C++', 5, '1500.00'),
(13, 5, 'service', 'Nail Cutting (Big Breed)', 1, '150.00'),
(14, 6, 'item', 'Cat Food (70mg)', 5, '505.00'),
(15, 6, 'item', 'Cat Food (50mg)', 5, '510.00'),
(16, 7, 'item', 'Cat Food (70mg)', 5, '505.00'),
(17, 7, 'item', 'Cat Food (50mg)', 1, '102.00'),
(18, 8, 'item', 'Cat Food (70mg)', 5, '505.00'),
(19, 8, 'item', 'Cat Food (50mg)', 5, '510.00'),
(20, 9, 'item', 'Cat Food (70mg)', 5, '505.00'),
(21, 9, 'item', 'Cat Food (50mg)', 2, '204.00'),
(22, 9, 'item', 'Cat lace', 7, '7000.00'),
(23, 10, 'item', 'Cat lace', 6, '6000.00'),
(24, 10, 'item', 'Dog Lace', 7, '392.00'),
(25, 10, 'item', 'Cat Food (70mg)', 1, '101.00'),
(26, 11, 'item', 'Cat Food (70mg)', 6, '606.00'),
(27, 11, 'item', 'Cat Food (50mg)', 3, '306.00'),
(28, 11, 'item', 'Dog Lace', 8, '448.00'),
(29, 12, 'item', 'Cat Food (70mg)', 7, '707.00'),
(30, 12, 'item', 'Cat Food (50mg)', 2, '204.00'),
(31, 12, 'service', 'Nail Cutting (Big Breed)', 1, '150.00'),
(32, 13, 'item', 'Cat Food (70mg)', 6, '606.00'),
(33, 13, 'item', 'Cat Food (50mg)', 5, '510.00'),
(34, 13, 'medicine', 'Carrots meds', 1, '90.00');
...
--
ALTER TABLE `tblinventoryformedicines`
  MODIFY `inv_med_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `tblsales_detail`
  MODIFY `salesdetail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
